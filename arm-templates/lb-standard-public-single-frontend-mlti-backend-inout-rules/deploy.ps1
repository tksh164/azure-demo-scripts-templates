param (
    [string] $ResourceGroupName = 'demo-lb-std-pub-inout-single-fe-multi-be',
...
New-AzResourceGroup -Name $ResourceGroupName -Location $ResourceGroupLocation -Tag @{ 'Usage' = 'Lab' } -Verbose -Force
